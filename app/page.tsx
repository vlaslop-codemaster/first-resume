...
[skills list]
  ...
  const handlePay = async () => {
    setPaying(true);
    try {
      sessionStorage.setItem("resumeOutput", output);
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero { position: relative; z-index: 10; text-align: center; padding: 5rem 1rem 3rem; }
        .pill {
        ...
        .subtitle { font-size: 1.05rem; color: #9ca3af; max-width: 440px; margin: 0 auto 2.5rem; line-height: 1.7; }
        .badges { display: flex; justify-content: center; flex-wrap: wrap; gap: 1.5rem; margin-bottom: 3rem; }
        .badge { display: flex; align-items: center; gap: 6px; font-size: 14px; color: #d1d5db; font-weight: 500; }
        .card { position: relative; z-index: 10; max-width: 580px; margin: 0 auto; padding: 0 1rem 3rem; }
        .form-card {
        ...
        .progress-seg { flex: 1; height: 4px; border-radius: 9999px; background: rgba(255,255,255,0.1); transition: background 0.3s; }
        .progress-seg.active { background: linear-gradient(90deg, #7c3aed, #ec4899); }
        .form-title { font-family: 'Sora', sans-serif; font-size: 1.15rem; font-weight: 700; color: #fff; margin-bottom: 4px; }
        .form-subtitle { font-size: 13px; color: #6b7280; margin-bottom: 1.25rem; }
        ...
        input, textarea {
          ...
          color: #e8e0f0; outline: none;
          transition: border 0.2s, background 0.2s; resize: vertical;
        }
        input::placeholder, textarea::placeholder { color: #4b5563; }
        input:focus, textarea:focus { border-color: rgba(124,58,237,0.6); background: rgba(124,58,237,0.08); }
        .btn-primary {
          width: 100%;
          background: linear-gradient(135deg, #7c3aed, #ec4899);
        ...
        .output-card {
          background: rgba(255,255,255,0.04);
          border: 1px solid rgba(255,255,255,0.1);
          border-radius: 24px; margin-top: 1.5rem; overflow: hidden;
          backdrop-filter: blur(20px);
          box-shadow: 0 8px 40px rgba(0,0,0,0.4);
        }
        .output-header { padding: 1.5rem 2rem; border-bottom: 1px solid rgba(255,255,255,0.08); }
        .output-title { font-family: 'Sora', sans-serif; font-weight: 700; font-size: 1rem; color: #fff; }
        .output-sub { font-size: 13px; color: #6b7280; margin-top: 4px; }
        .resume-text { white-space: pre-wrap; font-size: 14px; line-height: 1.8; color: #d1d5db; font-family: 'DM Sans', sans-serif; margin: 0; }
        .resume-visible { padding: 1.5rem 2rem 0; }
        .resume-locked { position: relative; padding: 0 2rem; }
        .resume-blurred { filter: blur(5px); user-select: none; pointer-events: none; }
        .lock-overlay {
        ...
        .lock-icon { font-size: 2rem; margin-bottom: 0.75rem; display: block; }
        .lock-title { font-family: 'Sora', sans-serif; font-weight: 700; font-size: 1.05rem; color: #fff; margin-bottom: 6px; }
        .lock-sub { font-size: 14px; color: #6b7280; margin-bottom: 1.25rem; }
        .btn-unlock {
          background: linear-gradient(135deg, #7c3aed, #ec4899);
          color: #fff; border: none; border-radius: 12px;
          padding: 14px 36px; font-size: 15px; font-weight: 700;
          font-family: 'Sora', sans-serif; cursor: pointer; transition: opacity 0.2s, transform 0.1s;
        }
        ...
        footer {
          position: relative; z-index: 10;
          text-align: center; padding: 2rem; color: #4b5563; font-size: 13px;
              ...
              <div>
                ...
                <div className="fields">
                  ...
                  <div className="btn-row">
                    ...
                    <button className="btn-primary" onClick={generateResume} disabled={loading} style={{ flex: 2 }}>
